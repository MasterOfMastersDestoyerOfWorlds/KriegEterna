...
namespace KriegTests
{
    ...
    using EnemyClick = TestCards.EnemyClick;
    ...
    public class TestPowers : TestCaseCollection
    {
        public override List<TestCase> getCases()
        {
            ...
            new TestCase
            {
                ...
                scoreRows = new List<(RowEffected, int)>{
                    (RowEffected.PlayerMelee, 15),
                    (RowEffected.EnemyRanged, 2),
                },
                clicks = new List<Click>{
            ...
            new TestCase
            {
                testName = "FateDiscardPower",
                playerHandCount = 1,
                clicks = new List<Click>{
                    new Click("Knight", RowEffected.PlayerHand, RowEffected.PlayerHand, RowEffected.PlayerHand, true),
                    new Click("Knight", RowEffected.PlayerHand, RowEffected.PlayerMelee, RowEffected.PlayerHand, true),
                    new Click("Famine", RowEffected.PlayerHand, RowEffected.PowerGraveyard, RowEffected.PowerGraveyard, false),
                    new Click("Fate", RowEffected.PlayerHand, RowEffected.PlayerHand, RowEffected.PlayerMelee, true),
                    new Click("Fate", RowEffected.PlayerHand, RowEffected.PlayerHand, RowEffected.PlayerMelee, true),
                    new Click("Famine", RowEffected.PlayerChooseN, RowEffected.PowerGraveyard, RowEffected.PowerGraveyard, true),
                }
            },

            new TestCase
            {
                testName = "FateAttachment",
                playerHandCount = 1,
                clicks = new List<Click>{
                    new Click("Famine", RowEffected.PlayerHand, RowEffected.PlayerHand, RowEffected.PlayerHand, true),
            ...
            new TestCase
            {
                ...
                clicks = new List<Click>{
                    ...
                    new Click("Knight3", RowEffected.PlayerMelee, RowEffected.PlayerMelee, RowEffected.PlayerRanged, true),
            ...
            new TestCase
            {
                ...
                clicks = new List<Click>{
                    new Click("Relic", RowEffected.PlayerHand, RowEffected.PlayerHand, RowEffected.PowerGraveyard, true),
                    new Click("Knight3", RowEffected.EnemyMelee, RowEffected.EnemyMelee, RowEffected.EnemySiege, true),
                    new ClickRow("PlayerRanged", RowEffected.PlayerRanged),
            ...
            new TestCase
            {
                ...
                clicks = new List<Click>{
                    ...
                    new Click("Soldier", RowEffected.UnitGraveyard, RowEffected.UnitGraveyard, RowEffected.PlayerRanged, false),
                    new Click("Soldier", RowEffected.PlayerChooseN, RowEffected.PlayerRanged, RowEffected.PlayerRanged, true),
                }
            },
            new TestCase
            {
                ...
                clicks = new List<Click>{
                    new Click("Resurrection", RowEffected.PlayerHand, RowEffected.PlayerHand, RowEffected.PowerGraveyard, true),
                    new Click("Resurrection", RowEffected.PlayerHand, RowEffected.PlayerHand, RowEffected.PowerGraveyard, true),
                    new Click("Knight", RowEffected.UnitGraveyard, RowEffected.PlayerMelee, RowEffected.PlayerMelee, false),
                    new Click("Knight3", RowEffected.UnitGraveyard, RowEffected.UnitGraveyard, RowEffected.UnitGraveyard, false),
                    new ClickRow("Skip", RowEffected.Skip),
                    new Click("Knight", RowEffected.PlayerChooseN, RowEffected.PlayerMelee, RowEffected.PlayerMelee, true),
                }
            },
            new TestCase
            {
            ...
            new TestCase
            {
                testName = "UsuryNoRoundAdvance",
                clicks = new List<Click>{
                    new Click("Knight3", RowEffected.PlayerHand, RowEffected.PlayerSetAside, RowEffected.PlayerSetAside, false),
                    new Click("Knight", RowEffected.PlayerHand, RowEffected.PlayerSetAside, RowEffected.PlayerSetAside, false),
                    new Click("Knight9", RowEffected.PlayerHand, RowEffected.PlayerSetAside, RowEffected.PlayerSetAside, false),
                    new Click("Usury", RowEffected.PlayerHand, RowEffected.PlayerHand, RowEffected.PowerGraveyard, true),
                    new Click("Usury", RowEffected.PlayerHand, RowEffected.PlayerHand, RowEffected.PowerGraveyard, true),
                    new Click("Knight3", RowEffected.PlayerChooseN, RowEffected.PlayerSetAside, RowEffected.PlayerSetAside, true),
                    new Click("Knight", RowEffected.PlayerChooseN, RowEffected.PlayerSetAside, RowEffected.PlayerSetAside, true),
                    new Click("Knight9", RowEffected.PlayerChooseN, RowEffected.PlayerSetAside, RowEffected.PlayerSetAside, true),
                }
            },
            new TestCase
            {
                ...
                round = RoundType.RoundTwo,
                clicks = new List<Click>{
                    new Click("Soldier", RowEffected.PlayerHand, RowEffected.PlayerSetAside, RowEffected.PlayerRanged, false),
                    new Click("Knight", RowEffected.PlayerHand, RowEffected.PlayerSetAside, RowEffected.PlayerMelee, false),
                    new Click("Officer", RowEffected.PlayerHand, RowEffected.PlayerSetAside, RowEffected.PlayerMelee, false),
                    new Click("Usury", RowEffected.PlayerHand, RowEffected.PlayerHand, RowEffected.PowerGraveyard, true),
                    new Click("Usury", RowEffected.PlayerHand, RowEffected.PlayerHand, RowEffected.PowerGraveyard, true),
                    new Click("Soldier", RowEffected.PlayerChooseN, RowEffected.PlayerSetAside, RowEffected.PlayerRanged, true),
                    new Click("Knight", RowEffected.PlayerChooseN, RowEffected.PlayerSetAside, RowEffected.PlayerMelee, true),
                    new Click("Officer", RowEffected.PlayerChooseN, RowEffected.PlayerSetAside, RowEffected.PlayerMelee, true),
                    new ClickRow("Pass", RowEffected.Pass),
                    new ClickRow("UnitGraveyard", RowEffected.UnitGraveyard),
                    new ClickRow("PowerGraveyard", RowEffected.PowerGraveyard),
            ...
            new TestCase
            {
                ...
                clicks = new List<Click>{
                    ...
                    new Click("Knight3", RowEffected.PlayerMelee, RowEffected.UnitGraveyard, RowEffected.UnitGraveyard, true),
                    new Click("Grenadier2", RowEffected.PlayerRanged, RowEffected.UnitGraveyard, RowEffected.UnitGraveyard, true),
                    new EnemyClick("Soldier2", RowEffected.EnemyRanged, RowEffected.UnitGraveyard, RowEffected.UnitGraveyard, false),
                    new EnemyClick("Soldier", RowEffected.EnemyRanged, RowEffected.UnitGraveyard, RowEffected.UnitGraveyard, false),
                    new Click("Grenadier", RowEffected.EnemyRanged, RowEffected.EnemyRanged, RowEffected.EnemyRanged, false),
                }
            },
            new TestCase
            {
                ...
                clicks = new List<Click>{
                    ...
                    new Click("Grenadier2", RowEffected.PlayerRanged, RowEffected.PlayerRanged, RowEffected.PlayerRanged, false),
                    new ClickRow("Skip", RowEffected.Skip),
                    new Click("Soldier2", RowEffected.EnemyRanged, RowEffected.EnemyRanged, RowEffected.EnemyRanged, false),
                    new Click("Soldier", RowEffected.EnemyRanged, RowEffected.EnemyRanged, RowEffected.EnemyRanged, false),
                    new EnemyClick("Grenadier", RowEffected.EnemyRanged, RowEffected.UnitGraveyard, RowEffected.UnitGraveyard, true),
                }
            },
            new TestCase
            {
            ...
            new TestCase
            {
                ...
                clicks = new List<Click>{
                    ...
                    new Click("Knight", RowEffected.EnemyMelee, RowEffected.EnemyMelee, RowEffected.EnemyMelee, true),
                    new Click("Knight3", RowEffected.EnemyMelee, RowEffected.EnemyMelee, RowEffected.EnemyMelee, false),
                    new Click("Knight9", RowEffected.PlayerMelee, RowEffected.PlayerMelee, RowEffected.PlayerMelee, false),
                }
            },
            new TestCase
            {
                ...
                clicks = new List<Click>{
                    ...
                    new ClickRow("UnitGraveyard", RowEffected.UnitGraveyard),
                    new Click("Knight", RowEffected.UnitGraveyard, RowEffected.UnitGraveyard, RowEffected.UnitGraveyard, false),
                    new Click("Knight3", RowEffected.UnitGraveyard, RowEffected.UnitGraveyard, RowEffected.PlayerMelee, false),
                    new Click("Soldier", RowEffected.UnitGraveyard, RowEffected.UnitGraveyard, RowEffected.PlayerRanged, false),
                }
            },
            ...
            new TestCase
            {
                testName = "GrailSwitch",
                playerHandCount = 0,
                clicks = new List<Click>{
                    new Click("Grail", RowEffected.PlayerHand, RowEffected.PlayerHand, RowEffected.PowerGraveyard, true),
                    new ClickRow("UnitGraveyard", RowEffected.UnitGraveyard),
                    new Click("Crusader", RowEffected.UnitGraveyard, RowEffected.UnitGraveyard, RowEffected.UnitGraveyard, false),
                    new Click("Soldier", RowEffected.UnitGraveyard, RowEffected.UnitGraveyard, RowEffected.PlayerRanged, false),
                    new Click("Officer", RowEffected.UnitGraveyard, RowEffected.UnitGraveyard, RowEffected.PlayerMelee, false),
                }
            },
        };
        }
